...
public class ObjectFactory {
    ...
    private final static QName _RegistrarResponse_QNAME = new QName("http://ws.jaad.cibertec.edu/", "registrarResponse");
    private final static QName _Consultar_QNAME = new QName("http://ws.jaad.cibertec.edu/", "consultar");
    private final static QName _Registrar_QNAME = new QName("http://ws.jaad.cibertec.edu/", "registrar");
    private final static QName _ConsultarResponse_QNAME = new QName("http://ws.jaad.cibertec.edu/", "consultarResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.jaad.cibertec.edu/", name = "registrarResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.jaad.cibertec.edu/", name = "consultar")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.jaad.cibertec.edu/", name = "registrar")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.jaad.cibertec.edu/", name = "consultarResponse")
