...
import pe.com.dyd.patrones.ejemplos.abstractfactory.util.PropertiesUtil;
...
public class ServiceStackAbstractFactory {
	...
	public static IServiceStackAbstractFactory createServiceFactory() {
		Properties props = PropertiesUtil.loadProperty("AbstractFactoryConfiguration.properties");
