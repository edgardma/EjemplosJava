package pe.com.dyd.patrones.ejemplos.composite;

import java.util.Random;

import pe.com.dyd.patrones.ejemplos.composite.orders.SaleOrder;
import pe.com.dyd.patrones.ejemplos.composite.products.CompositeProduct;
import pe.com.dyd.patrones.ejemplos.composite.products.SimpleProduct;
...
public class CompositeMain {
	...
	private void orderBig() {
		SaleOrder customOrder = new SaleOrder(4, "Luis Gonzales");
